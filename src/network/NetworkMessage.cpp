...
NetworkMessage NetworkMessage::createHandshakeAck(const std::string& client_id,
                                                   bool               game_started) {
    NetworkMessage msg;
...
NetworkMessage NetworkMessage::createMoveObject(const std::string& object_id,
                                                float              x,
                                                float              y) {
    NetworkMessage msg;
...
NetworkMessage NetworkMessage::createUndoRequest(uint32_t target_seq) {
    NetworkMessage msg;
    msg.type              = MessageType::UndoRequest;
    msg.data["targetSeq"] = target_seq;
    return msg;
}
...
std::string NetworkMessage::toString() const {
    std::string str = "[";
    switch (type) {
        case MessageType::Handshake:      str += "Handshake";      break;
        case MessageType::HandshakeAck:   str += "HandshakeAck";   break;
        case MessageType::Ping:           str += "Ping";           break;
        case MessageType::Pong:           str += "Pong";           break;
        case MessageType::Disconnect:     str += "Disconnect";     break;
        case MessageType::PlayerJoined:   str += "PlayerJoined";   break;
        case MessageType::PlayerLeft:     str += "PlayerLeft";     break;
        case MessageType::PlayerReady:    str += "PlayerReady";    break;
        case MessageType::StartGame:      str += "StartGame";      break;
        case MessageType::Snapshot:       str += "Snapshot";       break;
        case MessageType::Event:          str += "Event";          break;
        case MessageType::MoveObject:     str += "MoveObject";     break;
        case MessageType::ActionRejected: str += "ActionRejected"; break;
        case MessageType::Chat:           str += "Chat";           break;
